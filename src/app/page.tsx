...
export default function Home() {
  ...
  return (
    <main className="w-11/12 lg:w-5/6 mx-auto ">
      <section className="mb-32 grid justify-start grid-cols-[auto_65%] md:grid-cols-[auto_85%] lg:grid-cols-[auto_70%] xl:grid-cols-[auto_78%] 2xl:grid-cols-[auto_83%] 3xl:grid-cols-[auto_87%]">
        <aside>
          <NavigationBar />
        </aside>
      ...
      <section className="border-b mb-10">
        ...
        <div className="flex mb-10 gap-12 lg:gap-24">
          <h2 className="text-exclusive-text-2 font-inter font-semibold text-xl md:text-3xl">Flash Sales</h2>
          <span>counter</span>
        </div>
