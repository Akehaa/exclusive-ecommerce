    ...
    <>
      ...
      <div className="flex flex-col w-5/6 mx-auto xl:flex-row xl:gap-44">
        ...
        <div className="xl:w-full">
          ...
          <button className="bg-exclusive-secondary hover:bg-exclusive-secondary-hover h-fit duration-200 text-exclusive-text-1 py-4 px-12 text-sm font-medium mb-16 rounded md:text-base ">Proceed to Payment</button>
        </div>
      </div>
    </>
  )
