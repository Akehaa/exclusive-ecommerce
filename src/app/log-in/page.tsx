...
export default function page() {
  return (
    <div className="flex flex-col lg:mt-16 lg:mb-16 lg:flex-row">
      ...
      <div className="flex flex-col items-center mb-16 mx-6 md:mx-20 lg:items-start lg:justify-center 2xl:mx-auto">
        ...
        <div className="flex w-full justify-between items-center">
          <button className="bg-exclusive-secondary hover:bg-exclusive-secondary-hover duration-200 rounded text-exclusive-text-1 py-4 px-12">Log in</button>
